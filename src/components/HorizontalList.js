    ...
    if (cat != 'link' && cat != 'link2') {
      ...
      Linking.openURL(
        cat == 'link'
          ...
          : Platform.select({
              android:
                'https://play.google.com/store/apps/details?id=com.eFlashGerman',
              ios: 'https://apps.apple.com/us/app/learn-german-baby-flash-cards/id398463258',
            }),
      );
    }
  };
